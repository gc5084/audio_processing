...
computeSNR("../../sounds/sax-phrase-short.wav","hamming",512,1024,64)
...
computeSNR("../../sounds/rain.wav","hann",1024,2048,128)
...
#computeSNR("../../sounds/piano.wav","blackman",513,2048,128)
#computeSNR("../../sounds/sax-phrase-short.wav","hamming",512,1024,64)
